...
const STRINGS = [
  ...
  { id:"bg65", brand:"Yonex", name:"BG65", price:21, gauge:"0.70mm", type:"Multifilament",
    ...
    profile:{durabilite:95,controle:70,vitesse:60,puissance:65,feeling:70}, tension:{min:18,max:30,rec:24},
  ...
  { id:"bg65ti", brand:"Yonex", name:"BG65 Ti", price:21, gauge:"0.70mm", type:"Multifilament",
    ...
    profile:{durabilite:92,controle:72,vitesse:65,puissance:78,feeling:72}, tension:{min:18,max:30,rec:24},
  ...
  { id:"bg80", brand:"Yonex", name:"BG80", price:21, gauge:"0.68mm", type:"Multifilament",
    ...
    profile:{durabilite:70,controle:90,vitesse:75,puissance:75,feeling:85}, tension:{min:20,max:30,rec:26},
  ...
  { id:"bg80power", brand:"Yonex", name:"BG80 Power", price:21, gauge:"0.68mm", type:"Multifilament",
    colors:[{id:"blanc",name:"Blanc",hex:"#F0F0F0"},{id:"jaune",name:"Jaune",hex:"#FFD700"}],
    profile:{durabilite:72,controle:82,vitesse:76,puissance:88,feeling:80}, tension:{min:20,max:30,rec:26},
  ...
  { id:"bg66um", brand:"Yonex", name:"BG66 Ultimax", price:21, gauge:"0.65mm", type:"Monofilament",
    ...
    profile:{durabilite:55,controle:80,vitesse:95,puissance:80,feeling:90}, tension:{min:20,max:30,rec:26},
  ...
  { id:"aerosonic", brand:"Yonex", name:"Aerosonic", price:21, gauge:"0.61mm", type:"Monofilament",
    ...
    profile:{durabilite:40,controle:85,vitesse:90,puissance:70,feeling:95}, tension:{min:18,max:28,rec:24},
  ...
  { id:"aerobite", brand:"Yonex", name:"Aerobite", price:21, gauge:"0.61/0.67mm", type:"Hybride",
    ...
    profile:{durabilite:45,controle:88,vitesse:92,puissance:78,feeling:94}, tension:{min:20,max:30,rec:26},
  ...
  { id:"aerobite-boost", brand:"Yonex", name:"Aerobite Boost", price:21, gauge:"0.61/0.72mm", type:"Hybride",
    ...
    profile:{durabilite:58,controle:86,vitesse:88,puissance:80,feeling:90}, tension:{min:20,max:30,rec:25},
  ...
  { id:"exbolt63", brand:"Yonex", name:"Exbolt 63", price:21, gauge:"0.63mm", type:"Monofilament",
    ...
    profile:{durabilite:50,controle:82,vitesse:98,puissance:82,feeling:92}, tension:{min:20,max:30,rec:27},
  ...
  { id:"exbolt65", brand:"Yonex", name:"Exbolt 65", price:21, gauge:"0.65mm", type:"Monofilament",
    ...
    profile:{durabilite:62,controle:85,vitesse:92,puissance:84,feeling:88}, tension:{min:20,max:30,rec:26},
  ...
  { id:"exbolt68", brand:"Yonex", name:"Exbolt 68", price:21, gauge:"0.68mm", type:"Monofilament",
    colors:[{id:"blanc",name:"Blanc",hex:"#F0F0F0"},{id:"jaune",name:"Jaune",hex:"#FFD700"},{id:"bleu",name:"Bleu",hex:"#1E90FF"}],
    profile:{durabilite:75,controle:90,vitesse:82,puissance:82,feeling:85}, tension:{min:19,max:30,rec:25},
  ...
  { id:"vbs66n", brand:"Victor", name:"VBS-66N", price:21, gauge:"0.66mm", type:"Multifilament",
    ...
    profile:{durabilite:65,controle:85,vitesse:80,puissance:75,feeling:80}, tension:{min:20,max:30,rec:25},
  ...
  { id:"vbs70", brand:"Victor", name:"VBS-70", price:21, gauge:"0.70mm", type:"Multifilament",
    ...
    profile:{durabilite:85,controle:75,vitesse:70,puissance:85,feeling:70}, tension:{min:18,max:30,rec:24},
  ...
  { id:"no1", brand:"Li-Ning", name:"No.1", price:21, gauge:"0.65mm", type:"Monofilament",
    ...
    profile:{durabilite:50,controle:80,vitesse:95,puissance:85,feeling:88}, tension:{min:20,max:30,rec:26},
  ...
  { id:"ap65", brand:"Li-Ning", name:"AP65", price:21, gauge:"0.65mm", type:"Multifilament",
    ...
    profile:{durabilite:75,controle:72,vitesse:75,puissance:70,feeling:72}, tension:{min:18,max:28,rec:23},
  ...
  { id:"zymax62", brand:"Ashaway", name:"Zymax 62 Fire", price:21, gauge:"0.62mm", type:"Monofilament",
    ...
    profile:{durabilite:45,controle:82,vitesse:98,puissance:80,feeling:92}, tension:{min:20,max:30,rec:27},
  ...
  { id:"zymax66", brand:"Ashaway", name:"Zymax 66 Fire", price:21, gauge:"0.66mm", type:"Monofilament",
    ...
    profile:{durabilite:60,controle:85,vitesse:88,puissance:82,feeling:86}, tension:{min:20,max:30,rec:26},
  ...
  { id:"zymax68tx", brand:"Ashaway", name:"Zymax 68 TX", price:21, gauge:"0.68mm", type:"Monofilament",
    ...
    profile:{durabilite:70,controle:88,vitesse:80,puissance:85,feeling:84}, tension:{min:19,max:30,rec:25},
  ...
  { id:"micropower", brand:"Ashaway", name:"Micropower", price:21, gauge:"0.70mm", type:"Multifilament",
    ...
    profile:{durabilite:85,controle:75,vitesse:70,puissance:78,feeling:74}, tension:{min:18,max:28,rec:23},
          ...
          <div className="fade" style={{ maxWidth:380, margin:"80px auto 0" }}>
            ...
            <div style={{ ...G.card, padding:28, display:"flex", flexDirection:"column", gap:14 }}>
              <Input type="password" placeholder="Code admin" value={adminPwd} onChange={e => setAdminPwd(e.target.value)}
                onKeyDown={e => { if(e.key==="Enter") { if(adminPwd===ADMIN_CODE) setIsAdmin(true); else notify("Code incorrect","err"); }}} />
              <Btn style={{ width:"100%" }} onClick={() => { if(adminPwd===ADMIN_CODE) setIsAdmin(true); else notify("Code incorrect","err"); }}>
                Accéder
              </Btn>
            </div>
          </div>
